      ...
      <div className='gradient h-screen flex flex-col items-center align-top justify-center'>
        <div className='bg-white h-screen w-screen mt-10 flex flex-row md:h-2/3 md:w-1/3  align-middle justify-center rounded-md'>
          <div className='w-screen flex flex-col items-center align-middle justify-center'>
            ...
            <form className='flex flex-col align-middle justify-center w-full sm:w-3/5 ' action="">
              <div className='flex flex-col md:flex-row'>
                <InputRegister campo="Nombre" nombre="nombre" />
                <InputRegister campo="Apellido" nombre="apellido" />
              </div>
              <div className='flex flex-col md:flex-row'>
                <InputRegister campo="Teléfono" nombre="telefono" placeholder={"Formato 3624123456"} />
                <InputRegister campo="Nombre de usuario" nombre="username" />
              </div>
              <div className='flex flex-col md:flex-row'>
                <InputRegister campo="Contraseña" nombre="pass" />
                <InputRegister campo="Repite la contraseña" nombre="passrepeat" />
              </div>
              <div className='flex flex-col md:flex-row'>
                <InputRegister campo="N° de Credencial" nombre="credencial" />
                {/*@ts-ignore*/}
                <SelectRegister campo="Unidad" opciones={jerarquiaCampos}/>
              </div>
              <div className='flex flex-col md:flex-row'>
                <InputRegister campo="N° de Plaza" nombre="plaza" />
                <InputRegister campo="Zona" nombre="jerarquia" />
              </div>
              {/*@ts-ignore*/}
              <SelectRegister campo="Unidad" opciones={unidadCampos}/>
