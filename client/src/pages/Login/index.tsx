...
function Login() {
  ...
  return (
    <div className='bg-transparent sm:bg-sky-900 h-screen flex flex-col items-center align-middle justify-center'>
      <div className='bg-white h-screen w-screen md:h-2/3 md:w-1/3 flex align-middle justify-center rounded-xl'>
        <div className='w-screen flex flex-col items-center align-middle justify-center'>
         ...
         <figure className='flex flex-col'>
          ...
          <form className='flex flex-col items-center align-middle justify-center w-4/5 sm:w-3/5' action="">
            <input className='border open-sans border-gray-300 w-full rounded-md h-10 my-2' type='text' placeholder="Usuario"
