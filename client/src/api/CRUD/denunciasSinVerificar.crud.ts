...
export const crearDenunciaSinVerificar = async (denuncia: any) => {
    try {
        const response:any = await axios.post(`/crear-denuncia-sin-verificar/`, denuncia)
...
export const buscarAmpliaciones = async (id: any) => {
    try {
        const response = await axios.get(`/buscar-ampliaciones/${id}`, )
        return response.data
    } catch (error) {
        console.log(error)
    }
...
export const agregarAmpliacionDenuncia = async (id: string, idAmpliacion: string) => {
    try {
        const response = await axios.put(`/agregar-ampliacion/${id}/${idAmpliacion}`)
        return response.data
    } catch (error) {
        console.log(error)
    }
