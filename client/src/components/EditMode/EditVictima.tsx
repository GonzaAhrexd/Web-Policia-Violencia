    ...
    return (
        <div className={`w-full ${md && "lg:w-6/10"}`}>
            ...
            <div className='flex flex-col my-2'>
                ...
                {isCondicionVulnerabilidad &&
                    <div className={`grid grid-cols-1 md:grid-cols-3 my-2 bg-slate-100 border-2 md:border-0  border-slate-500 md:bg-white rounded-md`}>
                        ...
                        <InputCheckbox campo="Periodo Post-parto" nombre="periodo_post_parto" register={register} setValue={setValue} type="checkbox" error={errors.periodo_post_parto} id="periodo_post_parto" state={datos.condiciones_de_vulnerabilidad.periodo_post_parto}/>
            ...
            <div className='flex flex-col my-2'>
                ...
                <InputRadio watch={watch} handleChange={setIsHijos} campo="hijos" nombre="hijos" register={register} type="radio" opciones={opcionesHijos} defaultValue={datos.hijos.tiene_hijos ? 0 : 1} />
            </div>
            {isHijos &&
