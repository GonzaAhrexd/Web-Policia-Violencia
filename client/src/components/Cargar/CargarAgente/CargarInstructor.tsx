  ...
  return (
    <>
      ...
      <div className='flex justify-center'>
        <div className='w-full lg:w-6/10'>
          <div className='flex flex-col lg:flex-row my-2'>
            <InputRegister notMidMD={true} campo="Nombre y apellido" nombre="nombre_completo_instructor" register={register} setValue={setValue} type="text" error={errors.nombre_completo_instructor} />
      ...
      <div className='flex justify-center'>
        <div className='w-full lg:w-6/10'>
          <div className='flex flex-col lg:flex-row my-2'>
            <InputRegister notMidMD={true} campo="Nombre y apellido" nombre="nombre_completo_secretario" register={register} setValue={setValue} type="text" error={errors.nombre_completo_instructor} />
            ...
            <InputRegister notMidMD={true} campo="Plaza" nombre="plaza_secretario" register={register} setValue={setValue} type="text" error={errors.plaza} />
          </div>
        </div>
      </div>
    </>
