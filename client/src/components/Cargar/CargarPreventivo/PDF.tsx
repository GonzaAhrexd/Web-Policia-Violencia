        ...
        <Document>
            <Page style={styles.page}>
                ...
                <View style={styles.section}>
                    ...
                    <Text style={styles.text}>{espacioEnBlanco(75)}Cumplo en dirigirme a Ud. llevando a su conocimiento que en la fecha {new Date(datos.fecha).getUTCDate()} de {meses[new Date(datos.fecha).getUTCMonth() + 1]} de {new Date(datos.fecha).getUTCFullYear()} inició sumario policial judicial en base a denuncia radicada por el ciudadano quien se identificó como {datos.nombre_victima} {datos.apellido_victima} de {datos.edad_victima} años de edad, nacionalidad {datos.nacionalidad_victima}, {datos.estado_civil_victima}, {datos.sabe_leer_y_escribir_victima ? "con instrucción" : "sin instrucción"}, {datos.ocupacion_victima}, con domicilio en {datos.direccion_victima}, DNI N° {datos.DNI_victima}, teléfono N° {datos.telefono_victima}. Dando cuenta que: </Text>
        ...
        <Document>
            <Page style={styles.page}>
                ...
                <View style={styles.section}>
                    ...
                    <Text style={styles.sectionRight}>{municipio}, {new Date(datos.fecha).getUTCDate()} de {meses[new Date(datos.fecha).getUTCMonth() + 1]} de {new Date(datos.fecha).getUTCFullYear()}
                    </Text>
                    </View>
                    <Text style={styles.text}>**********************************************************************************************************</Text>
                    <Text style={styles.text}>SRES: {datos.autoridades}</Text>
