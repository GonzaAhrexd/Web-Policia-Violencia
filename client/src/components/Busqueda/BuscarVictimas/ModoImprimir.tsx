...
function modoImprimir({modoImprimir, setModoImprimir, denunciasAMostrar, user, data }: modoImprimirProps) {
    ...
    <div className='my-5 flex flex-col md:flex-row items-center justify-center w-full '>
        <button className='bg-sky-950 hover:bg-sky-900 text-white cursor-pointer font-bold py-2 px-4 rounded w-6/10 md:w-2/10 flex items-center justify-center mx-2 mt-2 md:mt-0'>
