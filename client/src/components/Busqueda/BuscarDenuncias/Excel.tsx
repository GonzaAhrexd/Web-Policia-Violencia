...
function Excel({ denunciasAMostrar }: denuncia) {
  ...
  const exportarDenuncias = () => {
    ...
    hoja['AS1'] = { v: 'Domicilio de la víctima', t: 's' };
    hoja['AT1'] = { v: 'Estado civil de la víctima', t: 's' };
    hoja['AU1'] = { v: 'Ocupación de la víctima', t: 's' };
    hoja['AV1'] = { v: 'Vínculo con el agresor de la víctima', t: 's' };
    hoja['AW1'] = { v: 'Condición de vulnerabilidad de la víctima', t: 's' };
    hoja['AX1'] = { v: 'Embarazo', t: 's' };
    hoja['AY1'] = { v: 'Post parto', t: 's' };
    hoja['AZ1'] = { v: 'Lactancia', t: 's' };
    hoja['BA1'] = { v: 'Discapacidad', t: 's' };
    hoja['BB1'] = { v: 'Enfermedad crónica', t: 's' };
    hoja['BC1'] = { v: 'Adulto mayor', t: 's' };
    hoja['BD1'] = { v: 'Menor de edad', t: 's' };
    hoja['BE1'] = { v: 'Tratamiento psicológico', t: 's' };
    hoja['BF1'] = { v: 'Convivencia', t: 's' };
    hoja['BG1'] = { v: 'Dependencia económica', t: 's' };
    hoja['BH1'] = { v: 'Cantidad de denuncias previas', t: 's' };
    hoja['BI1'] = { v: 'Tiene hijos', t: 's' };
    hoja['BJ1'] = { v: 'Mayores de edad', t: 's' };
    hoja['BK1'] = { v: 'Menores de edad', t: 's' };
    hoja['BL1'] = { v: 'Menores discapacitados', t: 's' };
    hoja['BM1'] = { v: 'Hijos con el agresor', t: 's' };
    hoja['BN1'] = { v: 'Nombre del victimario', t: 's' };
    hoja['BO1'] = { v: 'Apellido del victimario', t: 's' };
    hoja['BP1'] = { v: 'Edad del victimario', t: 's' };
    hoja['BQ1'] = { v: 'DNI del victimario', t: 's' };
    hoja['BR1'] = { v: 'Domicilio del victimario', t: 's' };
    hoja['BS1'] = { v: 'Estado civil del victimario', t: 's' };
    hoja['BT1'] = { v: 'Ocupación del victimario', t: 's' };
    hoja['BU1'] = { v: 'Abuso de alcohol del victimario', t: 's' };
    hoja['BV1'] = { v: 'Antecedentes toxicológicos del victimario', t: 's' };
    hoja['BW1'] = { v: 'Antecedentes penales del victimario', t: 's' };
    hoja['BX1'] = { v: 'Antecedentes contravencionales del victimario', t: 's' };
    hoja['BY1'] = { v: 'Entrenamiento en combate del victimario', t: 's' };
    hoja['BZ1'] = { v: 'Denuncias previas en contra', t: 's' };
    hoja['CA1'] = { v: 'Nombre del tercero', t: 's' };
    hoja['CB1'] = { v: 'Apellido del tercero', t: 's' };
    hoja['CC1'] = { v: 'DNI del tercero', t: 's' };
    hoja['CD1'] = { v: 'Vínculo del tercero con la víctima', t: 's' };
