...
function CardProfileInfo({ user, setIsEditing, isEditing }) {
    return (
        ...
        <div className="h-full  bg-sky-950 pt-12 rounded-xl ">
            <div className="w-8/10 mx-auto bg-sky-900 rounded-lg overflow-hidden shadow-lg h-95/100">
                <div className=" px-4 pb-6">
                    ...
                    <div className="flex gap-2 px-2">
                        <button
                            className="flex-1 rounded-full bg-sky-950 hover:bg-sky-500 text-white dark:text-white antialiased font-bold hover:bg-blue-800 dark:hover:bg-blue-900 px-4 py-2" onClick={() => setIsEditing(!isEditing)}>
                            Modificar Datos
                        </button>
